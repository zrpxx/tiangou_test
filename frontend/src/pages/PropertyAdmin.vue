...
export default {
  ...
  methods: {
    updateTable() {
      this.properties = []
      let _this = this
      this.$axios.get('http://127.0.0.1:8000/api/properties/' + this.categoryMap.get(this.currentCategory)).then(function (response) {
        let res = response.data
        console.log(res)
    ...
    onSubmitAdd() {
      let _this = this
      this.$axios.post('http://127.0.0.1:8000/api/property/create', {
    ...
    onSubmitEdit() {
      let _this = this
      this.$axios.post('http://127.0.0.1:8000/api/property/update', {
    ...
    onDelete() {
      let _this = this
      this.$axios.delete('http://127.0.0.1:8000/api/property/delete', {
        data:{
