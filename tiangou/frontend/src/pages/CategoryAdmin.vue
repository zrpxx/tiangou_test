...
export default {
  ...
  methods: {
    onSubmitAdd() {
      let _this = this
      this.$axios.post('https://tiangou.zrp.cool/api/category/create', {
        name: _this.newName
    ...
    onSubmitEdit() {
      let _this = this
      this.$axios.post('https://tiangou.zrp.cool/api/category/update', {
        id: _this.id,
    ...
    onDelete() {
      let _this = this
      this.$axios.delete('https://tiangou.zrp.cool/api/category/delete', {
        data:{
          id: this.deleteID
        }
      }).then(function (response) {
