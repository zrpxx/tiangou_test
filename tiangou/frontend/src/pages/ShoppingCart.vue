...
export default {
  ...
  created() {
    this.loading = true
    let _this = this
    this.$axios.post('https://tiangou.zrp.cool/api/cart/products',{
  ...
  methods: {
    ...
    onConfirmDelete() {
      let _this = this
      this.$axios.delete('https://tiangou.zrp.cool/api/cart/delete', {
        data: {
          uid: this.$store.state.userid,
          pid: this.deleteID
        }
    ...
    onGenerate() {
      ...
      console.log(pids)
      let _this = this
      this.$axios.post('https://tiangou.zrp.cool/api/order/create', {
    ...
    onPay() {
      ...
      this.$axios.post('https://tiangou.zrp.cool/api/order/create', {
        ...
        if(res.status === 'Success') {
          ...
          _this.$axios.post('https://tiangou.zrp.cool/api/order/pay', {
