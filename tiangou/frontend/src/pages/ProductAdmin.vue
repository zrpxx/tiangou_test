  ...
  methods: {
    onSubmitAdd() {
      ...
      reader.onload = function () {
        ...
        _this.$axios.post('https://tiangou.zrp.cool/api/product/create', {
    ...
    onSubmitEdit() {
      let _this = this
        ...
        _this.$axios.post('https://tiangou.zrp.cool/api/product/update', {
          product_id: _this.id,
          product_name: _this.newName,
          product_subtitle: _this.newSubtitle,
          original_price: _this.newOriginalPrice,
    ...
    onDelete() {
      let _this = this
      this.$axios.delete('https://tiangou.zrp.cool/api/product/delete', {
        data:{
    ...
    onSetImage(props) {
      ...
      let _this = this
      this.$axios.get('https://tiangou.zrp.cool/api/product/' + this.id).then(function (response) {
          let res = response.data
    ...
    onSubmitSetImg() {
      if(this.newDetail !== null)
      {
        ...
        reader.onload = function () {
          console.log(reader.result)
          _this.$axios.post('https://tiangou.zrp.cool/api/product_image/update', {
            product_id: _this.id,
    ...
    onSetProperty(props) {
      ...
      this.properties = []
      let _this = this
      this.$axios.get('https://tiangou.zrp.cool/api/properties/' + props.row.category_id).then(function (response) {
        let res = response.data
        console.log(res)
    ...
    onSubmitSetProperty() {
      ...
      for(let key in this.newProperty) {
        this.$axios.post('https://tiangou.zrp.cool/api/product_property/update',{
          product_id: _this.id,
