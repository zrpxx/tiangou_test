  ...
  <q-layout view="hHh lpR fFf">
    ...
    >
      <q-scroll-area class="fit">
        <div class="q-pa-sm">
          <q-list>
            <q-item v-ripple exact to="/" v-if="!$store.state.loggedIn && ($route.path === '/' || $route.path === '/store' || $route.path === '/detail')">
            ...
            <q-item v-ripple exact to="/product" v-if="$route.path === '/product'">
              <q-item-section avatar>
                <q-icon name="info"/>
              </q-item-section>
              <q-item-section>
